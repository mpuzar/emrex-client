...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        prepareOpts: function (opts) {
            ...
            opts = $.extend({}, {
                ...
                formatInputTooShort: function (input, min) { return "Vennligst skriv inn " + (min - input.length) + " flere tegn"; },
                formatLoadMore: function (pageNumber) { return "Laster flere..."; },
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        initContainer: function () {
            ...
            containers.delegate(selector, "focus", function () { if (this.enabled) {
