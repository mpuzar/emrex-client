...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        // Matija - trenges for hjelpetekstene
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        setPlaceholder: function () {
            ...
            // if (this.opts.element.val() === "" && placeholder !== undefined) {  // Matija
            if ((this.opts.element.val() === "" || this.opts.element.val() === "NULL") && placeholder !== undefined) {
        ...
        updateSelection: function (data) {
            ...
            if (formatted !== undefined) {
                ...
                this.selection.attr('title', this.opts.escapeMarkup(formatted));
            }
    ...
    $.fn.select2.defaults = {
        ...
        escapeMarkup: function (markup) {
            if (markup && typeof(markup) === "string") {
                return markup.replace(/&/g, "&amp;").replace(/\<\s*script/,'&lt;script');
            }
            return markup;
        },
        blurOnChange: false
...
// Matija -- Dette for å unngå at man ved bruk i popup opplever veldig stygg oppførsel 
jQuerySun(window).scroll(function() {
	jQuerySun(".select2-container.select2-dropdown-open").not(jQuerySun(this)).select2('positionDropdown');
});
