...
<xsl:template match="/">
   <html>
      <head>
        ...
        <link href="resources/daisydiff/css/diff.css" type="text/css" rel="stylesheet"/>
      </head>
      <body>
      <script src="resources/daisydiff/js/tooltip/wz_tooltip.js" type="text/javascript"></script>
      <script src="resources/daisydiff/js/tooltip/tip_balloon.js" type="text/javascript"></script>
      <script src="resources/daisydiff/js/dojo/dojo.js" type="text/javascript"></script>
      <script src="resources/daisydiff/js/diff.js" type="text/javascript"></script>
      <script>
        htmlDiffInit();
      </script>
        ...
        <tr><td style="text-align: left;">
            <a>
              ...
              <img class="diff-icon"
                src="resources/daisydiff/images/diff-first.gif"
                title="Første endring"/>
            </a>
            <a>
              <xsl:attribute name="class">diffpage-html-a</xsl:attribute>
              <xsl:attribute name="onclick">scrollToEvent(event)</xsl:attribute>
        ...
        <td style="text-align: right;">
            ...
            <a>
              ...
              <img class="diff-icon"
                src="resources/daisydiff/images/diff-last.gif"
                title="Siste endring"/>
            </a>
         </td></tr></table>
         </div-->
